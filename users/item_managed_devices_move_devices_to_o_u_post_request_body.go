...
func (m *ItemManagedDevicesMoveDevicesToOUPostRequestBody) GetAdditionalData() map[string]any {
...
func (m *ItemManagedDevicesMoveDevicesToOUPostRequestBody) SetAdditionalData(value map[string]any) {
